...
def validate_schemas():
    ...
    jsonschema.validate(
        {
            "aidee_version": "v0.1.0-alpha.9",
            "source_commit": "a" * 40,
            "tag": "aidee-assistant:0.1.0-alpha.9-aaaaaaaaaaaa",
...
def validate_setup_guidance():
    ...
    if latest != "v0.1.0-alpha.9":
        raise AssertionError("LATEST does not name the Alpha 9 release")
